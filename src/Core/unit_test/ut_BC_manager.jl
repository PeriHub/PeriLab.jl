...
testDatamanager.create_constant_node_field("Coordinates")
testDatamanager.create_constant_node_field("Forces")
testDatamanager.create_constant_node_field("Displacements")
testDatamanager.set_dof() = 2
