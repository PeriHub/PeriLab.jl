% SPDX-FileCopyrightText: 2023 Martin Raedel <martin.raedel@dlr.de>, Christian Willberg <christian.willberg@dlr.de>, Jan-Timo Hesse <jan-timo.hesse@dlr.de>
%
...
\begin{tikzpicture}
  % External figure
  \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.7\linewidth]{Discretization_BondFilters_RectangularPlane_Base}};
% Figure scope
  \begin{scope}[
    x={(image.south east)},
    y={(image.north west)},
