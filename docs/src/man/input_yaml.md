...
- **Blocks**: List of block configurations.
  - **_block\_id_**: Block-specific parameters.
...
- **_Own\_Name_**: List of boundary condition configurations.
...
- **_Own\_Name_**: List of compute class parameters.
...
- **Node Sets**: Dictionary of node sets. (optional)
  - **_Own\_Name_**: Numeric value or string representing the node set. (Int64 or String)
...
- **Bond Filters**: List of bond filter configurations. (optional)
  - **_Own\_Name_**: Bond filter parameters.
...
- **_Own\_Name_**: List of output configurations.
  ...
  - **Output Variables**: Dictionary of output variables.
    - **_Own\_Name_**: Boolean indicating whether to output the variable.

## `Physics (optional)`

- **Damage Models**: Dictionary of damage models. (optional)
  - **_Own\_Name_**: List of damage model configurations.
    ...
    - **Interblock Damage**: Dictionary of interblock damage parameters.
      - **_Own\_Name_**: Numeric value representing interblock damage. (Float64 or Int64, required)
...
- **Material Models**: Dictionary of [material models](physics/materials.md). (optional)
  - **_Own\_Name_**: List of material model configurations.
    - **Material Model**: String representing the material model.
...
- **Thermal Models**: Dictionary of thermal models. (optional)
  - **_Own\_Name_**: List of thermal model configurations.
...
- **Additive Models**: Dictionary of additive models. (optional)
  - **_Own\_Name_**: List of additive model configurations.
