...
PeriLab.Data_Manager.set_max_rank(1)
PeriLab.Data_Manager.set_distribution([1, 2, 3, 4, 5])
PeriLab.Data_Manager.create_constant_node_vector_field("Coordinates", Float64, 2)
coordinates = PeriLab.Data_Manager.get_field("Coordinates")
...
@testset "ut_init_write_result_and_write_results" begin
    ...
    PeriLab.Data_Manager.data["output_frequency"] = [
...
@testset "ut_init_orientations_3d" begin
    ...
    # PeriLab.Data_Manager.set_max_rank(1)
    # PeriLab.Data_Manager.set_distribution([1, 2, 3, 4, 5])
    # PeriLab.Data_Manager.create_constant_node_field("Coordinates", Float64, 2)
    # coordinates = PeriLab.Data_Manager.get_field("Coordinates")
    # coordinates[1, 1] = 0
    # coordinates[1, 2] = 0
    # coordinates[1, 3] = 0
    ...
    # coordinates[5, 2] = 2
    # coordinates[5, 3] = 0
    angles = PeriLab.Data_Manager.create_constant_node_vector_field("Angles", Float64, 3;
                                                                    default_value = 90)
