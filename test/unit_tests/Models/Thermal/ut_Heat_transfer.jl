...
@testset "ut_calculate_specific_volume" begin
    ...
    nlist[9] = [6, 8]
    nlist[10] = [9]
    bond_norm = PeriLab.Data_Manager.create_constant_bond_vector_state("Bond Norm", Float64,
                                                                       dof)
    bond_norm[1] = [[1, 0], [-1, 0]]
...
@testset "ut_compute_thermal_model" begin
    PeriLab.Data_Manager.create_node_scalar_field("Heat Flow", Float64)
    PeriLab.Data_Manager.create_node_scalar_field("Temperature", Float64)
