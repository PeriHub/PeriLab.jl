...
@testset "HETVAL_interface Tests" begin
    ...
    CMNAME::Cstring = PeriLab.Solver_Manager.Model_Factory.Thermal.HETVAL.malloc_cstring("HETVAL_TEST")  # Adjust as needed
    ...
    PeriLab.Solver_Manager.Model_Factory.Thermal.HETVAL.hetval_file_path = file
    PeriLab.Solver_Manager.Model_Factory.Thermal.HETVAL.HETVAL_interface(CMNAME, TEMP, TIME,
                                                                         DTIME, STATEV,
                                                                         FLUX, PREDEF,
                                                                         DPRED)
    @test FLUX[1] == 100
