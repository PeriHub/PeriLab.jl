...
@testset "ut_init_model" begin
    ...
    @test_logs (:error,
        ...
        PeriLab.Solver_Manager.Model_Factory.Material.Correspondence.init_model([
                                                                                    1,
                                                                                    2
                                                                                ],
                                                                                1,
    ...
    @test_logs (:error,
                "No correspondence material of name Correspondence Non_Exist exists.") @test_throws PeriLab.PeriLabError begin
        PeriLab.Solver_Manager.Model_Factory.Material.Correspondence.init_model([
                                                                                    1,
                                                                                    2
                                                                                ],
