...
@testset "ut_create_element_matrices" begin
    ...
    @test N[2, 1:4, :] == [0.16666666666666663 0.0; 0.0 0.16666666666666663; 0.044658198738520435 0.0; 0.0 0.044658198738520435]
    @test N[3, 1:4, :] == [0.16666666666666663 0.0; 0.0 0.16666666666666663; 0.6220084679281462 0.0; 0.0 0.6220084679281462]
    ...
    @test N[2, 5:8, :] == [0.6220084679281462 0.0; 0.0 0.6220084679281462; 0.16666666666666663 0.0; 0.0 0.16666666666666663]
    @test N[3, 5:8, :] == [0.044658198738520435 0.0; 0.0 0.044658198738520435; 0.16666666666666663 0.0; 0.0 0.16666666666666663]
    @test N[4, 5:8, :] == [0.16666666666666663 0.0; 0.0 0.16666666666666663; 0.6220084679281462 0.0; 0.0 0.6220084679281462]

    @test B[3, 1:6, 1] == [-0.39433756729740643, 0.0, 0.39433756729740643, 0.0, -0.10566243270259354, 0.0]
    @test B[3, 1:6, 2] == [0.0, -0.10566243270259354, 0.0, -0.39433756729740643, 0.0, 0.10566243270259354]
    @test B[3, 1:6, 3] == [-0.10566243270259354, -0.39433756729740643, -0.39433756729740643, 0.39433756729740643, 0.10566243270259354, -0.10566243270259354]
    ...
    @test N[4, 8:10, :] == [0.0 0.13144585576580212 0.0; 0.0 0.0 0.13144585576580212; 0.035220810900864506 0.0 0.0]
    @test B[7, 1:5, 1] == [-0.08333333333333331, 0.0, 0.0, 0.08333333333333331, 0.0]
    @test B[7, 1:5, 2] == [0.0, -0.08333333333333331, 0.0, 0.0, -0.3110042339640731]
    @test B[7, 1:5, 3] == [0.0, 0.0, -0.022329099369260218, 0.0, 0.0]
    @test B[7, 1:5, 4] == [0.0, -0.022329099369260218, -0.08333333333333331, 0.0, -0.08333333333333331]
    @test B[7, 1:5, 5] == [-0.022329099369260218, 0.0, -0.08333333333333331, -0.08333333333333331, 0.0]
    @test B[7, 1:5, 6] == [-0.08333333333333331, -0.08333333333333331, 0.0, -0.3110042339640731, 0.08333333333333331]
