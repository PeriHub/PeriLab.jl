...
nlist = dm.create_constant_bond_field("Neighborhoodlist", Int64, 1, 1)
...
external_forces = dm.create_node_field("External Forces", Float64, dof)
external_force_densities = dm.create_node_field("External Force Densities", Float64, dof)
